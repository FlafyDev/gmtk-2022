...
var page = 0;
#var pages = [
#	"The casino game \"Mischievous Die\" requires 4 players."\
...
var pages = [
	"In this game you play as a mishieveous die that can decide the outcome of each roll.",
	"But which opponents should win and which should lose?",
